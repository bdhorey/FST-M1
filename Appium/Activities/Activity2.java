...
public class Activity2 {
    ...
    public void testSearchAppium() throws InterruptedException {
		...
		/*
		 * // Open page in browser driver.get("https://www.training-support.net/");
		 * 
		 * // Wait for page to load
		 * wait.until(ExpectedConditions.elementToBeClickable(MobileBy.
		 * AccessibilityId("About Us")));
		 * 
		 * // Get heading on page and print it String pageTitle = driver
		 * .findElementByXPath("//android.widget.TextView[@text='Training Support']")
		 * .getText(); System.out.println("Title on Homepage: " + pageTitle);
		 * 
		 * // Find About Us button and click it MobileElement aboutButton =
		 * driver.findElementByXPath("//android.view.View[@content-desc='About Us']");
		 * aboutButton.click();
		 * 
		 ...
		 * 
		 * // Get heading on About Us page and print it String newPageTitle = driver
		 * .findElementByXPath("//android.widget.TextView[@text='About Us']")
		 * .getText(); System.out.println("Title on new page: " + newPageTitle);
		 * 
		 * // Assertions Assert.assertEquals(pageTitle, "Training Support");
		 * Assert.assertEquals(newPageTitle, "About Us");
		 */
    }
